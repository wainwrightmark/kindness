...
**kindness** is proudly licenced under the MIT license, and so are all
contributions. Please see the [`LICENSE`] file in this directory for more details.

[`LICENSE`]: https://github.com/wainwrightmark/kindness/blob/main/LICENSE

## Pull Requests

To make changes to **kindness**, please send in pull requests on GitHub to
...
GitHub](https://github.com/wainwrightmark/kindness/issues). If you've found a
problem with **kindness**, please open an issue there.

<!--
We use the following labels:

* `enhancement`: This is for any request for new sections or functionality.
* `bug`: This is for anything that's in `kindness`, but incorrect or not working.
* `discussion`: A discussion about improving something in `kindness`; this may
...
Report bugs at https://github.com/wainwrightmark/kindness/issues.
...
kindness could always use more documentation, whether as part of the
official kindness docs, in docstrings, or even on the web in blog posts,
articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at https://github.com/wainwrightmark/kindness/issues.
...
Ready to contribute? Here's how to set up `kindness` for local development.

1. Fork the `kindness` repo on GitHub.
2. Clone your fork locally:
    ```shell
    $ git clone git@github.com:your_name_here/kindness.git
    ```
